...
An enterprise-grade, OpenGAP-compliant AI agent for **Manufacturing & supply chain**, engineered for framework portability across OpenAI SDK, CrewAI, Claude Code, and Lyzr.

## Domain Overview
- **Category:** Manufacturing & supply chain
- **Primary Role:** Chief Aeronautical Systems Engineer
